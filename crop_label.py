...
trainImgPath = '/mnt/tvmerge_rotate180/images'
trainLabelPath = '/mnt/tvmerge_rotate180/labels'

# 生成数据集，valid_croped_mode, 需要自己手动创建文件夹valid_croped_mode3和并在其下面创建Image文件夹
createImg_root = '/mnt/tvmerge_crop/images'
csvFile = open("/mnt/tvmerge_crop/Label.csv", "w")
...
# 模板四使用
typelist = ['手写汉字', '手写汉字', '手写汉字', '手写汉字', '手写数字', '字符', '字符', '印刷汉字', '印刷汉字', '联合汉字', '联合汉字', '联合汉字', '印刷汉字', '印刷数字', '印刷数字', '印刷数字', '印刷数字', '印刷数字', '印章汉字', '印章汉字', '印章汉字']
