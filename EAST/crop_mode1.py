...
if __name__ == '__main__':
    ...
    model_path = '/root/last_dataset/east_tmp_pths/east_model_20_0.2399.pth'
    ...
    trainImgPath = '/root/last_dataset/test_result/test_rotate180/'

    create_label = '/root/last_dataset/test_result/test_crop2.txt'
    ...
    with open(create_label, 'w') as lb:
        for root, dirs, files in os.walk(trainImgPath):#trainLabelPath):
            for file in sorted(files):
                ...
                ####
                #img_savepath = os.path.join('/home/chen-ubuntu/Desktop/checks_dataset/res_det/mode1', file[:-4] + '_origin' +  '.jpg')
                ...
                #plot_img.save(os.path.join('/home/chen-ubuntu/Desktop/checks_dataset/res_det/mode1', file[:-4] + '_detected' + '.jpg'))
                orig_vertices = []
                theta = 0
                for box in boxes:
                    box = np.array(box[:8])
                ...
                #img_savepath = os.path.join('/home/chen-ubuntu/Desktop/checks_dataset/res_det/mode1', file[:-4] + '_rotated' + '.jpg')
                ...
                for i, j in enumerate(index):
                    ...
                    if j == 6:
                        if int(xcenter[0][0].split(',')[1]) > int(xcenter[1][0].split(',')[1]):
                            ...
                            xcenter[0] = xcenter[1]
                            xcenter[1] = tmp
                        if int(xcenter[1][0].split(',')[1]) > int(xcenter[2][0].split(',')[1]):
                            tmp = xcenter[1]
                            xcenter[1] = xcenter[2]
                            xcenter[2] = tmp
                        if int(xcenter[0][0].split(',')[1]) > int(xcenter[1][0].split(',')[1]):
                        ...
                        if int(xcenter[3][0].split(',')[1]) > int(xcenter[4][0].split(',')[1]):
                            ...
                            xcenter[3] = xcenter[4]
                            xcenter[4] = tmp
                        if int(xcenter[4][0].split(',')[1]) > int(xcenter[5][0].split(',')[1]):
                            tmp = xcenter[4]
                            xcenter[4] = xcenter[5]
                            xcenter[5] = tmp
                        if int(xcenter[3][0].split(',')[1]) > int(xcenter[4][0].split(',')[1]):
                ...
                for i, item in enumerate(shape):
                    ...
                    img_savepath = os.path.join('/root/last_dataset/test_result/test_crop2', img_newname)
