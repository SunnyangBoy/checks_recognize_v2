...
if __name__ == '__main__':
    ...
    model_path = '/root/last_dataset/east_seal_tmp_pth/east_model_17_0.1918.pth'
    ...
    create_label = '/root/last_dataset/test_result/test_stamp_crop.txt'
                ...
                for file in sorted(files):
                    ...
                    if boxes is not None and boxes.size:
                        ...
                        for i, item in enumerate(shape):
                            ...
                            img_savepath = os.path.join('/root/last_dataset/test_result/test_stamp_crop', img_newname)
